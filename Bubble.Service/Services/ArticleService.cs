...
public class ArticleService : IArticleService
{
    ...
    public async Task<int> GetArticlesPagesAmount(GetArticlesPagesAmountRequest request)
    {
        return await _mediator.Send(new GetArticlesPagesAmountQuery { filters = request });
    }
